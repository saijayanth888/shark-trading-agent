...
## Shark Weekly Review 2026-05-08 | Grade B | +0.00% | Alpha +0.00%
<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<style>
  body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
...
<div class="card">
  <div class="header">
    <h1>🦈 Weekly Review — 2026-05-08</h1>
    <div class="sub">Week ending 2026-05-08 · Grade B</div>
  </div>
  
    <div class="kv"><span class="label">Grade</span>
      <span class="val green" style="font-size:20px">B</span></div>
    <div class="kv"><span class="label">Week Return</span>
      <span class="val green">+0.00%</span></div>
    <div class="kv"><span class="label">Alpha vs S&P 500</span>
      <span class="val green">+0.00pp</span></div>
    <div class="kv"><span class="label">Win Rate</span>
      <span class="val">0.0% (0W / 0L)</span></div>
    <div class="kv"><span class="label">Profit Factor</span><span class="val">∞</span></div>
    <div class="kv"><span class="label">Equity</span><span class="val">$100,000.00</span></div>
