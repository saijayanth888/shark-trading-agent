...
## Shark Morning Briefing — 2026-05-08 · BEAR_VOLATILE · 1 candidates
<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<style>
  body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
...
<div class="card">
  <div class="header">
    <h1>🦈 Morning Briefing — 2026-05-08</h1>
    <div class="sub">Pre-market scan · 2026-05-08</div>
  </div>
    ...
    <div class="kv"><span class="label">Macro</span>
      <span class="val green">NORMAL</span></div>
    <div class="kv"><span class="label">Macro Detail</span>
      <span class="val" style="font-size:12px;max-width:320px;text-align:right">No major macro events nearby</span></div>
    <div class="kv"><span class="label">Watchlist</span>
      <span class="val">30 tickers · 10 bullish · 3 bearish</span></div>
    ...
    <table><tr><th>Symbol</th><th>Score</th><th>Catalyst</th></tr><tr><td style='font-weight:600'>NVDA</td><td>4</td><td style='font-size:12px'>IREN partnership announcement for 5 GW AI infrastructure deployment with $30M stock purchase option at $70/share; Corning partnership for 10x optical connectivity manufacturing capacity expansion</td></tr></table>
